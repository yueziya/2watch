...
<input type="text" size="50" style="height:20px" id="username" name="username" />
<span class="mb25">
...
<div style="width:880px;height:40px; float:right;margin-top:10px;"align="left";>
<input type="password" size="50" style="height:20px" id="password" name="password" />
<span class="mb25">
...
<div style="width:880px;height:40px; float:right;margin-top:10px;"align="left";>
<input type="password" size="50" style="height:20px" id="qrpassword" name="qrpassword" />
<span class="mb25">
...
<div style="width:880px;height:40px; float:right;margin-top:10px;"align="left";>
<input type="text" value="" size="50" style="height:20px" id="email" name="email" />
<span class="mb25">
...
<div style="width:880px;height:40px; float:right;margin-top:10px;"align="left";>
<input type="text" value="" size="50" style="height:20px" id="tel" name="tel" />
<span class="mb25">
...
<div style="width:880px;height:40px; float:right;margin-top:10px;"align="left";><img src="images/zhuce.png" id="button" /></a></div>
...
<script type="text/javascript">
    $('#button').click(function(){
        ...
        var tel = $('#tel').val();
         $.ajax({
            data:{username:username,password:password,qrpassword:qrpassword,email:email,tel:tel},
            type:"post",
            dataType:"json",
            url:"?r=reg/reg",
            success:function (msg) {
                if(msg == 1){
                    alert("注册成功");location.href="?r=index/index";
                }else{
                    alert("注册失败");location.href = "?r=reg/reg";
                }
            }
        })
    })
