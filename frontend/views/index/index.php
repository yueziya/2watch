...
<div class="head">
  ...
  <div class="ri">
            ...
            $session=Yii::$app->session;
                ...
                if($_SESSION['user_id']){
            ?>     
               <span class="tLnk1"><a href="#" class="f12">欢迎<?=$_SESSION['username']?>登陆</a></span>
            <?php        
            }else{
            ?> 
...
<div class="idxBnd">
  ...
  <a   href="http:"" style="margin-right: 1px;_margin-right: 0px;"><a   href=""" style="margin-right: 1px;_margin-right: 0px;"><a   href=""" style="margin-right: 1px;_margin-right: 0px;"></a><a   href="http:"" style="margin-right: 1px;_margin-right: 0px;"><img src="Images/banimg1.jpg" alt=""  width="296" height="175"/></a><a   href="" style="margin-right: 1px;_margin-right: 0px;"><img width=298 height="175" src="Images/banimg2.jpg" alt="" /></a>
